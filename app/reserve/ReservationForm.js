            ...
            <div className={styles.formGroup}>
                <label className={styles.label}>
                    <input
                        ...
                        aria-describedby="largeGroupHelp"
                    />
                    Large Group (10+ people)?
                </label>
                <small id="largeGroupHelp" style={{ color: 'var(--text-secondary)' }}>For large groups, we will contact you to confirm arrangements.</small>
            </div>
