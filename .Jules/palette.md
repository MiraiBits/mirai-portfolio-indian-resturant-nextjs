...
## 2026-02-13 - Checkbox Helper Text Association
**Learning:** Checkboxes in this app often have helper text displayed visually nearby (e.g., in a `small` tag), but lack programmatic association for screen readers.
**Action:** Always use `aria-describedby` on the input element pointing to the ID of the helper text element to ensure context is announced.
