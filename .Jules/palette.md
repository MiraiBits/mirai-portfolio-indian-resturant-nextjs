...
## 2024-10-24 - Form Field Helper Text Association
**Learning:** Helper text placed visually near inputs (like checkboxes) is not automatically associated for screen reader users, leaving them unaware of crucial context.
**Action:** Always use `aria-describedby` on the input element pointing to the ID of the helper text container to programmatically link the description.
